...
public class ListaTablaGestionSuministrosPiezasModel extends AbstractTableModel {

    private final String[] columnas = {"ID GESTIÓN","PROVEEDOR", "PROYECTO", "PIEZA","CANTIDAD"};

    ArrayList<Gestion> gestiones = new ArrayList<>();

    public ListaTablaGestionSuministrosPiezasModel(ArrayList<Gestion> gestiones) {
